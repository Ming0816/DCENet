...
* To train the DCENet model with single gpu:
...
* Download the pre-trained [GoPro](https://drive.google.com/file/d/1AKht2iq5JzjMCK96b_9uT1SOJCjfZJ90/view?usp=drive_link) models and place them in ./dcenet/
...
### 2. Training
  * To train on **single-image** defocus deblurring task with single gpu:
```
...
* Download the pre-trained [Single-image](https://drive.google.com/file/d/1zjfDFeKKcDS3zC5Yorf3UUtyKJgBfFVZ/view?usp=sharing) and [dual-pixel](https://drive.google.com/file/d/1ouDQzJbSOlYvLtQAm5oYHZDqv4U-AWlf/view?usp=drive_link) models and place them in ./dcenet/
